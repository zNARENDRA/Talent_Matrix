...
export const Topbar: React.FC = () => {
  ...
  return (
    <header className="h-16 bg-white/80 dark:bg-surface-900/80 backdrop-blur-md border-b border-surface-200 dark:border-surface-800 flex items-center justify-between px-6 sticky top-0 z-30">
      {/* Search Bar / Quick Command Palette Trigger */}
      <button
        onClick={() => setCommandPaletteOpen(true)}
        className="flex items-center gap-2.5 px-3.5 py-2 rounded-xl bg-surface-100/90 dark:bg-surface-800/90 border border-surface-200/80 dark:border-surface-700/80 hover:border-primary-500/50 text-surface-400 hover:text-surface-600 dark:hover:text-surface-200 text-xs sm:text-sm transition-all w-80 md:w-96 group shadow-sm"
      >
        <Search className="w-4 h-4 shrink-0 text-surface-400 group-hover:text-primary-500 transition-colors" />
        <span className="truncate whitespace-nowrap text-left font-medium">
          Search students, companies, drives...
        </span>
        <kbd className="ml-auto shrink-0 text-[11px] font-mono font-bold bg-surface-200 dark:bg-surface-700 text-surface-500 dark:text-surface-300 px-1.5 py-0.5 rounded-md border border-surface-300/50 dark:border-surface-600/50">
          ⌘K
        </kbd>
      </button>
